...
pub struct HashFileReadTool;

impl AgentTool for HashFileReadTool {
    fn name(&self) -> &str {
        "hash_file_read"
    }
    ...
    fn execute(
        ...
        Box::pin(async move {
            ...
            let output = super::hashline::format_hash_lines(&selected_text, start_idx + 1);
...
impl HashFileReadTool {
    pub fn arc() -> Arc<dyn AgentTool> {
        Arc::new(HashFileReadTool)
    }
}
